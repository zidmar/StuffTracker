...
-- protected
insert into db_column (description,db_column_type_to_db_column_id,protected) values ('integrated_by',(select db_column_type_id from db_column_type where name = 'integer'),1);
alter table stuff_tracker add column integrated_by int4 null;

insert into db_column (description,db_column_type_to_db_column_id,protected) values ('updated_by',(select db_column_type_id from db_column_type where name = 'integer'),1);
